...
class Invoice(BaseModel):
    ...
    payment_provider = models.CharField(max_length=50, blank=True, null=True)  # pesaway, flutterwave, etc.
    ...
    def generate_invoice_number(cls) -> str:
        ...
        count = cls.objects.filter(invoice_number__startswith=f'INV-{timestamp}').count()
...
class InvoiceLineItem(BaseModel):
    ...
    item_type = models.CharField(max_length=50, blank=True)  # subscription, module, user, etc.
