...
class Payment(BaseModel):
    ...
    # Provider References
    provider_reference = models.CharField(max_length=255, blank=True, null=True)  # Transaction ID from provider
    provider_metadata = models.JSONField(default=dict, blank=True)  # Full response from provider
...
class PaymentMethod(BaseModel):
    ...
    card_brand = models.CharField(max_length=50, blank=True, null=True)  # visa, mastercard
