...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2, default=Decimal("800.00"), max_digits=10
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["code", "status"], name="billing_pro_code_7ec206_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                ...
                name="billing_pro_status_0e894e_idx",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="plan",
            index=models.Index(
                fields=["tier", "is_active"], name="billing_pla_tier_fdafe0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymentmethod",
            index=models.Index(
                fields=["corporate_id", "is_default"],
                name="billing_pay_corpora_eb273e_idx",
            ),
        ),
        migrations.AddField(
            model_name="payment",
        ...
        migrations.AddIndex(
            model_name="trial",
            index=models.Index(
                fields=["corporate_id", "status"], name="billing_tri_corpora_220815_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trial",
            index=models.Index(
                fields=["status", "end_date"], name="billing_tri_status_64632a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subscription",
            index=models.Index(
                fields=["corporate_id", "status"], name="billing_sub_corpora_940d92_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subscription",
            index=models.Index(
                fields=["status", "end_date"], name="billing_sub_status_c965d6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subscription",
            index=models.Index(
                fields=["trial_end_date"], name="billing_sub_trial_e_be9579_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotionusage",
            index=models.Index(
                fields=["promotion", "corporate_id"],
                name="billing_pro_promoti_2445bf_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["corporate_id", "status"], name="billing_pay_corpora_db86c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["provider_reference"], name="billing_pay_provide_f758e1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                ...
                name="billing_pay_payment_df14fe_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["corporate_id", "status"], name="billing_inv_corpora_e20f49_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
