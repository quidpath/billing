...
from .models import (
    Plan, PlanFeature, PlanModule, PlanModuleAssignment,
...
class PlanAdmin(admin.ModelAdmin):
    list_display = ['name', 'tier', 'price_monthly', 'included_users', 'is_active', 'is_featured']
    list_filter = ['tier', 'is_active', 'is_featured']


@admin.register(Subscription)
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = ['corporate_name', 'plan', 'status', 'billing_cycle', 'total_amount', 'start_date', 'end_date']
...
class InvoiceAdmin(admin.ModelAdmin):
    list_display = ['invoice_number', 'corporate_name', 'status', 'total_amount', 'due_date', 'paid_at']
    list_filter = ['status', 'currency']


@admin.register(Payment)
class PaymentAdmin(admin.ModelAdmin):
    list_display = ['corporate_name', 'amount', 'currency', 'payment_method', 'status', 'provider', 'paid_at']
