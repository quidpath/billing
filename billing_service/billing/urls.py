...
urlpatterns = [
    ...
    path('verification/initiate/', views.initiate_verification, name='initiate_verification'),
    path('verification/status/', views.verification_status, name='verification_status'),
    path('verification/complete/', views.complete_verification, name='complete_verification'),
    ...
    path('subscriptions/status/', views.get_subscription_status, name='get_subscription_status'),
